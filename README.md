...
3. In the terminal run npm run cypress:open 
...
5. Pick the preferred browser. 
6. Select any of the test suites under the cypress/e2e folder to run the test cases related to the feature.
